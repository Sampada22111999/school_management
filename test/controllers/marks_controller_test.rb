...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference("Mark.count") do
      post marks_url, params: { mark: { marks: @mark.marks, student_id: @mark.student_id, student_name: @mark.student_name, subject: @mark.subject, teacher_id: @mark.teacher_id } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { marks: @mark.marks, student_id: @mark.student_id, student_name: @mark.student_name, subject: @mark.subject, teacher_id: @mark.teacher_id } }
